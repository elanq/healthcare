                  ...
                  <div className="grid grid-cols-2 gap-6">
                    <div>
                      ...
                      <span className={`mt-1 inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium
                        ${appointmentData.status === 'PENDING' ? 'bg-yellow-100 text-yellow-800' :
                          appointmentData.status === 'CONFIRMED' ? 'bg-green-100 text-green-800' :
                    ...
                    {appointmentData.payment_detail && (
                      <div>
                        ...
                        <span className={`mt-1 inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium
                          ${appointmentData.payment_detail.status === 'PENDING' ? 'bg-yellow-100 text-yellow-800' :
                            appointmentData.payment_detail.status === 'PAID' ? 'bg-green-100 text-green-800' :
                            'bg-gray-100 text-gray-800'}`}>
